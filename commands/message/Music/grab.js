...
module.exports = {
    ...
    execute: async (message, args, client, prefix) => {
        ...
        const dmbut = new ButtonBuilder().setLabel("Support").setStyle(ButtonStyle.Link).setURL(`https://discord.gg/7mpruCM4YF`)
